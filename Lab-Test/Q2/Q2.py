...
# 2) Streamlit UI
# ----------------------------
st.set_page_config(page_title="Rule-Based Smart Home Air Conditioner Controller Web App (Streamlit)", page_icon="", layout="wide")
st.title("Rule-Based Smart Home Air Conditioner Controller Web App")
st.caption("Enter conditions, edit rules (optional), and evaluate. Designed to be a small, deployable example.")
